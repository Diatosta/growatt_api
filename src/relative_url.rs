...
impl RelativeUrl {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            RelativeUrl::TlxEnergyDayChart => "panel/tlx/getTLXEnergyDayChart_bdc",
            RelativeUrl::TlxEnergyMonthChart => "panel/tlx/getTLXEnergyMonthChart_bdc",
            RelativeUrl::TlxEnergyYearChart => "panel/tlx/getTLXEnergyYearChart_bdc",
            RelativeUrl::TlxEnergyTotalChart => "panel/tlx/getTLXEnergyTotalChart_bdc",
